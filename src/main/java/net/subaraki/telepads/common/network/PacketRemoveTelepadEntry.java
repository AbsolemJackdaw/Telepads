...
public class PacketRemoveTelepadEntry implements IMessage {
	...
	/**
	 * A packet to remove a TelepadEntry from a player's list of locations. This
	 ...
	 * side, a sync packet will automatically be send back to the client to
	 * ensure that everthing is consistent.
	 * 
	 * @param playerUUID
	 *            : The UUID of the player to remove the entry from.
	 * @param entry
	...
	public static class PacketRemoveTelepadEntryHandler implements
			IMessageHandler<PacketRemoveTelepadEntry, IMessage> {

		@Override
		public IMessage onMessage(PacketRemoveTelepadEntry packet,
				MessageContext ctx) {
