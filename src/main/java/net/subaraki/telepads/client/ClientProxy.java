...
public class ClientProxy extends CommonProxy {
	...
	public void preInit() {
		...
		MinecraftForgeClient.registerItemRenderer(
				Item.getItemFromBlock(Telepads.blockPad),
				new RenderItemTelepad());
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityTelepad.class,
				new RenderTileEntityTelepad());
	}
	...
	public void createTelepadParticleEffect(int x, int y, int z,
		...
		for (int particleCount = 0; particleCount < maxParticleCount; ++particleCount) {
			...
			world.spawnParticle(ConfigurationHandler.particleName, posX, posY,
					posZ, velocityX, volocityY, velocityZ);
		}
	}
