...
public class PacketDataOverDimensions implements IMessage {
	...
	public PacketDataOverDimensions(int x, int y, int z, int dimension,
			String name) {
	...
	public static class HandlerPacketDataOverDimensions implements
			IMessageHandler<PacketDataOverDimensions, IMessage> {

		@Override
		public IMessage onMessage(PacketDataOverDimensions message,
				MessageContext ctx) {

			PlayerPadData dat = PlayerPadData.get(Telepads.proxy
					.getClientPlayer());
